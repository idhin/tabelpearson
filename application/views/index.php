                        ...
                        <div class="sidebar-messages tab-pane fade show active" id="chat-content" role="tabpanel" aria-labelledby="chat-content">
                            ...
                            <div class="chat-list">
                                <a href="javascript:void(0)" class="chat-message">
                                    <div class="chat-item">
                                        <div class="chat-item-image">
                                            <img src="<?= base_url(); ?>assets/images/avatars/avatar1.png" class="circle" alt="">
                                        </div>
                                ...
                                <a href="javascript:void(0)" class="chat-message">
                                    <div class="chat-item">
                                        <div class="chat-item-image">
                                            <img src="<?= base_url(); ?>assets/images/avatars/avatar4.jpg" class="circle" alt="">
                                        </div>
                                        <div class="chat-item-info">
                                ...
                                <a href="javascript:void(0)" class="chat-message">
                                    <div class="chat-item">
                                        <div class="chat-item-image">
                                            <img src="<?= base_url(); ?>assets/images/avatars/avatar2.png" class="circle" alt="">
                                        </div>
                                        <div class="chat-item-info">
                                ...
                                <a href="javascript:void(0)" class="chat-message">
                                    <div class="chat-item">
                                        <div class="chat-item-image">
                                            <img src="<?= base_url(); ?>assets/images/avatars/avatar3.png" class="circle" alt="">
                                        </div>
                                        <div class="chat-item-info">
            ...
            <div class="chat-sidebar">
                ...
                <div class="messages-container">
                    <div class="message-wrapper them">
                        <div class="circle-wrapper"><img src="<?= base_url(); ?>assets/images/avatars/avatar1.png" class="circle" alt=""></div>
                        <div class="text-wrapper">Lorem Ipsum</div>
                    </div>
                    <div class="message-wrapper me">
                        <div class="circle-wrapper"><img src="<?= base_url(); ?>assets/images/avatars/avatar2.png" class="circle" alt=""></div>
