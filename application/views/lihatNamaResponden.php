                                            ...
                                            <?php if(count($listNamaResponden) == 0){
                                               ...
                                               <?php $no=1; foreach ($listNamaResponden as $row) { ?>
                                                <tr>
                                                    <th scope="row"><?= $no++; ?></th>
                                                    <td><?= $row->nama ?></td>
                                                    <td><a href="<?=  base_url();?>/kuisioner/lihatResponden/<?= $row->orangKe?>/<?= $this->uri->segment(3)?>" class="btn btn-primary btn-sm active waves-effect waves-light" role="button" aria-pressed="true">Lihat Jawaban</a></td>
