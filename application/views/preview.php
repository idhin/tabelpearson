...
<div style="padding-left:20px;padding-top:20px;padding-bottom:10px;padding-right:20px;">
<p>Nama Lengkap</p>
<input type="text" id="input" name="namaLengkap" placeholder="Jawaban Anda" disabled>
</div>
</div>
<br>
<div style="margin:auto;width:80%;background-color:#ffff;border-radius:5px;">
<div style="padding-left:20px;padding-top:20px;padding-bottom:10px;padding-right:20px;">
<p>Email</p>
<input type="text" id="input" name="email"  placeholder="Jawaban Anda" disabled>
</div>
</div>
<br>
...
<div class="form-check" style="margin-bottom: 10px">
  <input class="form-check-input" type="radio"  name="jawaban<?= $row->id ?>" value="<?= $row->jawabanA ?>" disabled>
  <label class="form-check-label" >
    <?= $row->jawabanA?>
  </label>
</div>
<div class="form-check" style="margin-bottom: 10px">
  <input class="form-check-input" type="radio" name="jawaban<?= $row->id ?>" value="<?= $row->jawabanB ?>" disabled>
  <label class="form-check-label" >
  <?= $row->jawabanB?>
  </label>
</div>
<div class="form-check" style="margin-bottom: 10px">
  <input class="form-check-input" type="radio" name="jawaban<?= $row->id ?>" value="<?= $row->jawabanC ?>" disabled>
  <label class="form-check-label">
  <?= $row->jawabanC?>
  </label>
</div>
<div class="form-check" style="margin-bottom: 10px">
  <input class="form-check-input" type="radio" name="jawaban<?= $row->id ?>" value="<?= $row->jawabanD ?>" disabled>
  <label class="form-check-label" >
  <?= $row->jawabanD?>
  </label>
</div>
...
<button disabled type="submit" class="btn" style="background-color: #4b0082;color:#ffff">Submit</button>
</div>
